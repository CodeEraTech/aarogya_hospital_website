...
<footer class="footer"><div class="wrap footer-grid"><div><a class="logo footer-logo" href="{{ route('home') }}"><img class="hospital-logo" src="{{ asset('assets/hospital/images/aarogya-logo.png') }}" alt="Dr. Bhutani’s Aarogya Hospital" width="597" height="250"></a><p>Advanced healthcare with modern technology and a human touch.</p></div><div><h3>Explore</h3><a href="{{ route('services.index') }}">Services</a><a href="{{ route('doctors.index') }}">Our Doctors</a><a href="{{ route('opd-schedule') }}">OPD Schedule</a><a href="{{ route('gallery') }}">Gallery</a><a href="{{ route('empanelled-corporate', ['slug' => config('empanelled.1.slug')]) }}">Empanelled Corporate</a></div><div><h3>Patient Care</h3><a href="{{ route('appointment.create') }}">Appointment</a><a href="{{ route('feedback.create') }}">Feedback</a><a href="{{ route('emergency') }}">Emergency</a></div><div><h3>Contact</h3><a href="{{ route('contact') }}">Contact page</a><a href="tel:+911662245450">01662-245450</a><a href="tel:+918222049007">+91 82220 49007</a><a href="tel:+918222049008">+91 82220 49008</a><span>Opposite Vishwas School, Near LIC Office, Urban Estate II, Hisar, Haryana 125001</span></div></div><div class="wrap footer-bottom"><span>© {{ now()->year }} Aarogya Hospital</span><span>Privacy · Terms · Disclaimer</span></div></footer>
